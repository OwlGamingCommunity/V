...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  UNIQUE KEY `discord_unique` (`discord`) USING BTREE,
  KEY `account_admin` (`admin`)
) ENGINE=InnoDB AUTO_INCREMENT=154414 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `bans` (
  ...
  `v_serial` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `tc_tickets` (
  ...
  `platform` int(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
